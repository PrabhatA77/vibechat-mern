  ...
  return (
    ...
    >
        ...
        {!isSubmitted ? (
          <form onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 px-4 bg-linear-to-r from-purple-500 to-indigo-600 text-white font-bold rounded-lg shadow-lg hover:from-purple-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200"
            >
              {isLoading ? (
      ...
      <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
        <Link to={"/login"}className="text-sm text-indigo-300 hover:underline flex items-center">
